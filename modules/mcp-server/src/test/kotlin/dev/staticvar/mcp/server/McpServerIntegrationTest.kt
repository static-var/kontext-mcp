...
class McpServerIntegrationTest {
    ...
    @Test
    fun `search_docs tool returns structured response`() = runTest {
    ...
    @Test
    fun `search_docs tool surfaces argument validation errors`() = runTest {
    ...
    private fun searchServiceWith(results: List<ScoredChunk>): SearchService {
        ...
        val repository = object : EmbeddingRepository {
