...
class OnnxCrossEncoderReranker(
    ...
    suspend fun init() {
        ...
        val embeddingConfig = EmbeddingConfig(
            ...
            dimension = 0, // Unused for download
            batchSize = 0, // Unused
            maxTokens = maxTokens
        )
    ...
    override suspend fun rerank(query: String, documents: List<String>): List<Int> = withContext(Dispatchers.IO) {
    ...
    private fun computeScore(query: String, document: String): Float {
