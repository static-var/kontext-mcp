...
class JsonbMapColumnType : ColumnType<Map<String, String>>() {
    ...
    override fun notNullValueToDB(value: Map<String, String>): Any = PGobject().apply {
        type = "jsonb"
    ...
    private fun encode(value: Map<String, String>): String =
...
fun Table.jsonbMap(name: String): Column<Map<String, String>> =
    registerColumn(name, JsonbMapColumnType())
