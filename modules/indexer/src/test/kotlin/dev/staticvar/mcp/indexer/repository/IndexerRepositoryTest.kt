...
class IndexerRepositoryTest {
    private val container =
        PostgreSQLContainer(DockerImageName.parse("pgvector/pgvector:pg16")).apply {
    ...
    @Test
    fun `source url repository lifecycle`() =
        runBlocking {
    ...
    @Test
    fun `document repository operations`() =
        runBlocking {
    ...
    @Test
    fun `embedding repository insert search and delete`() =
        runBlocking {
