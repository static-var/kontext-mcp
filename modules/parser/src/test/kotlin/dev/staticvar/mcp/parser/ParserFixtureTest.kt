...
class ParserFixtureTest {
    ...
    @Test
    fun `android baseline profiles overview fixture`() =
    ...
    @Test
    fun `android room release notes fixture`() =
        kotlinx.coroutines.runBlocking {
            val request =
                requestFromFixture(
    ...
    @Test
    fun `android room reference fixture`() =
        kotlinx.coroutines.runBlocking {
            val request =
                requestFromFixture(
    ...
    @Test
    fun `jetbrains exposed home fixture`() =
        kotlinx.coroutines.runBlocking {
            val request =
                requestFromFixture(
            ...
            val context =
                ParserContext(resourceLoader = { _ ->
    ...
    private fun requestFromFixture(
        url: String,
        fixture: String,
    ): ParseRequest =
        ParseRequest(
